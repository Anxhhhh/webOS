...
import { FolderPlus, FilePlus, Trash2, Pencil } from 'lucide-react';
import { useFileSystemStore } from '../../store/filesystem.store';
import { useShallow } from 'zustand/react/shallow';

export const ContextMenu: React.FC = () => {
  const { contextMenu, closeContextMenu, createFolder, createFile, deleteItem, setEditingId } = useFileSystemStore(
    useShallow((state) => ({
